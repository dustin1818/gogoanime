...
const airingData = ref([]);
const currentPage = ref(1);
const isLoading = ref(true);

onMounted(async () => {
  airingData.value = await store.fetchTopAiringAnime(currentPage.value);
        ...
        <div class="bg-[#222222] mt-6 p-0.5">
          ...
          >
            <div
              ...
              v-for="anime in airingData.data?.response"
              :key="anime.id"
            >
          ...
          <div
            class="w-full flex flex-row-reverse justify-center items-center gap-2.5 mb-3 mt-5"
          >
            <button
              @click="nextPage"
